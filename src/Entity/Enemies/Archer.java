...
public class Archer extends Enemy {
	...
	public Archer(TileMap tm) {
		...
		// load sprites
		try {
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/archer-better2.png"));
			
			sprites = new BufferedImage[10]; // 5 frames in this sprite
